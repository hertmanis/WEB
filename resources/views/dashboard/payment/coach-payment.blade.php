...
@section('content')
    <h1 class="text-3xl font-semibold text-center mb-8">Maksājumi</h1>

    <div class="max-w-xl mx-auto bg-white p-6 rounded shadow">
        <h2 class="text-xl font-semibold mb-4">Izveidot jaunu maksājumu</h2>
        
        <form method="POST" action="{{ route('coach.payments') }}">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="amount" id="amount" min="1" step="0.01" required class="w-full p-2 border rounded">
            </div>
        ...
        @foreach($payments as $payment)
            <div class="border p-3 rounded mb-3">
                ...
                <p><strong>Summa:</strong> €{{ number_format($payment->amount, 2) }}</p>
